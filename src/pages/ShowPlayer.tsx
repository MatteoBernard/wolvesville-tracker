        ...
        <Template>
            {error ? (
                ...
                <div className={"flex flex-col items-center p-6 m-12 border rounded-lg border-wv-red border-8 max-w-4xl mx-auto bg-wv-white"}>
                    ...
                    <img src={player.equippedAvatar.url} width={player.equippedAvatar.width * 1.5} height={player.equippedAvatar.height * 1.5} alt={`${player.username}'s avatar`}
                    ...
                    <div className={"flex justify-between w-full"}>
                        <div className={"w-1/2 p-4"}>
                            ...
                            <ul className={"list-none"}>
                                ...
                                <li className={"mb-4"}>
                                    <strong>Clan: </strong>
                                    {player.clanId ? (
                                        <Link to={`/clan/${player.clanId}`} className={"text-blue-500 underline p-1"}>
                                            View Clan
                                        </Link>
                                    ) : (
                                        "No clan"
                        ...
                        <div className={"w-1/2 p-4"}>
                            ...
                            <table className={"table-fixed w-full border-collapse border border-gray-400 rounded-lg"}>
                                <tbody>
                                <tr>
