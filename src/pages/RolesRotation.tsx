...
export const RolesRotation = () => {
    ...
    return (
        <Template>
            <div className="wv-red p-6 m-12 border rounded-lg border-wv-red border-8 max-w-4xl mx-auto bg-wv-white flex flex-col items-center">
                            ...
                            <div key={gameConfig.gameMode} className="mx-8 my-6">
                                ...
                                <ul className="list-none p-0">
                                    {gameConfig.roleRotations.map((roleRotation) => (
                                        <div key={roleRotation.roleRotation.id} className="mt-4">
                                            ...
                                            <p className="text-sm text-gray-500">Probability: {roleRotation.probability}</p>
                                        </div>
                                    ))}
                                </ul>
                            </div>
